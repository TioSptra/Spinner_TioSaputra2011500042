...
class MainActivity : AppCompatActivity() {
    ...
    val logo = intArrayOf(
        R.drawable.logo_pkp,R.drawable.logo_bangka,R.drawable.logo_babar,R.drawable.logo_bateng,R.drawable.logo_basel
                ,R.drawable.logo_belitung,R.drawable.logo_beltim
    )
